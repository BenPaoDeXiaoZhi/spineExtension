...
declare namespace spine{
	...
	class AttachmentTimeline implements Timeline {
		...
		apply(skeleton: Skeleton, lastTime: number, time: number, events: Array<Event>, alpha: number, blend: MixBlend, direction: MixDirection): void;
		setAttachment(skeleton: Skeleton, slot: spine.Slot, attachmentName: string): void;
	}
	...
	class AnimationState {
		...
		applyMixingFrom(to: TrackEntry, Skeleton: Skeleton, blend: spine.MixBlend): number;
...
export const spine38webgl:typeof spine
